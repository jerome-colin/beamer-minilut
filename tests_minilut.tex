...
\author{J. Colin\inst{1} \and O. Hagolle\inst{1}}% \and Igor Le Tractor\inst{3}}
...
\begin{frame}
\frametitle{Alta Floresta, 17 Sept. 2017}
	\includegraphics[width=1\textwidth]{figs/figs_BCXX/BC10/log21LWK_BC10_aerosols.png}
...
\frametitle{Exemple sur la Crau : $r_{M}$ et $RH$}
	\includegraphics[width=1\textwidth]{figs/figs_minilut/31TFJ_Dbg_MosaicProduit/log31TFJ_201908_minilut_debug_aerosols.png}
...
\frametitle{Piste 3 : Changement de la LUT Organic Matter}
	\begin{columns}
		...
		\end{column}
		\begin{column}{0.7\textwidth}	
		     	\includegraphics[width=0.95\textwidth]{figs/figs_OM/organic_matter_mi.png}
		     	\includegraphics[width=0.95\textwidth]{figs/figs_OM/organic_matter_mi_low.png}
		\end{column}
	\end{columns}
\end{frame}
%------------------------------------------------
...
\frametitle{Piste 3 : LUT avec $m_{i_{BC}} = 0.10$}
	\begin{center}
     	\includegraphics[width=0.75\textwidth]{figs/figs_BCXX/BC10/MosaicProduit/20170912S2B.jpg}
    \end{center}		
\end{frame}
...
\frametitle{Piste 3 : LUT avec $m_{i_{BC}} = 0.10$ ET $m_{i_{OM}}$ plafonné}
	\begin{center}
     	\includegraphics[width=0.75\textwidth]{figs/21LWK_BC10_OM006/MosaicProduit/20170912S2B.jpg}
    \end{center}		
\end{frame}
...
\frametitle{Piste 3 : LUT avec $m_{i_{BC}} = 0.10$ ET $m_{i_{OM}}$ plafonné}
	\begin{center}
     	\includegraphics[width=0.75\textwidth]{figs/21LWK_BC10_OM006/MosaicProduit/20170917S2A.jpg}
    \end{center}		
\end{frame}
...
\frametitle{Piste 3 : LUT avec $m_{i_{BC}} = 0.10$}
	\begin{center}
     	\includegraphics[width=0.75\textwidth]{figs/figs_BCXX/BC10/MosaicProduit/20170924S2A.jpg}
    \end{center}		
\end{frame}
...
\frametitle{Piste 3 : LUT avec $m_{i_{BC}} = 0.10$ ET $m_{i_{OM}}$ plafonné}
	\begin{center}
     	\includegraphics[width=0.75\textwidth]{figs/21LWK_BC10_OM006/MosaicProduit/20170924S2A.jpg}
    \end{center}		
\end{frame}
